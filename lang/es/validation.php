...
return [
    ...
    'array' => 'El campo :attribute debe ser un arreglo (array).',
    ...
    |--------------------------------------------------------------------------
    |
    | Aquí puedes especificar mensajes de validación personalizados usando
    | la convención "attribute.rule" para nombrar las líneas. Esto facilita
    | asignar un mensaje específico para una regla concreta de un atributo.
    |
    */
    ...
    | de atributos por algo más amigable para el lector, como "Dirección de
    | Correo" en lugar de "email". Esto simplemente nos ayuda a hacer
    | que los mensajes sean un poco más claros.
    |
    */
